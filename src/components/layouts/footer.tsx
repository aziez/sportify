        ...
        <aside>
          <div className="grid gap-4">
            ...
            <p className="text-pretty text-muted-foreground">
              Sewa tempat ataupun alat volly,bulutangkis,dan futsal. Web baru
              yang menawarkan bahan sewaan. Menyewakan barang pada kawasan
              Semarang dan sekitarnya. Jangan ragu untuk menghubungi kami apa
              yang Anda butuhkan untuk produksi terbaikmu
            </p>
          </div>
        </aside>
