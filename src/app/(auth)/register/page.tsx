...
import RegisterWithGoogle from '@/components/layouts/register/google-register';
            ...
            <div>
              ...
              <div className="mt-4 max-w-2xl md:mb-12">
                <h1 className="mb-4 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                  Anda lelah dengan rutinitas olahraga membosankan ?
                </h1>
                <p className="text-xl text-muted-foreground">
                  Di Sportify. Kamu tidak lagi kesepian dengan rekan olahraga
                  yang menyenangkan.!
                </p>
              </div>
              {/* End Title */}
